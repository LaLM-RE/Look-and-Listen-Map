# Look-and-Listen Map Fake Demo
# by Annette Thurow
# 2023-02-22
# Braunschweig Hauptbahnhof
# Version 0.1 mit Info über Objekte am Ort
# Vekrsion 0.2 for peer review
        ...
        if next_action in ("inventar", "inventory", "inv"):
            ...
            if next_object.lower() in (objektliste):
                ...
                if not current_location == current_room:
                    ...
                    if "beschreibung" in objekte[current_object]:
                        print(objekte[current_object]["beschreibung"])
                    else:
                        print("Es liegt keine Beschreibung vor.")
